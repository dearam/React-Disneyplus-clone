...
const Content=styled.div`
    ...
    display:flex;
    justify-content:center;/*ithan crta center postion ku vara vaikuthu */
    align-items:center;
    flex-direction:column; /*bcoz scroll pana column wise thana varum content ellam*/
    padding : 80px 40px;
    height :100%;
    `;
...
const BgImage=styled.div`
    height :100%;
    background-position:top;/*aprm kuduka pora text ellam image mela varanum la so kudukurom*/
